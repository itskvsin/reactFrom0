...
const RestaurantCard = (props) => {
  ...
  return (
    <div className="resCard" style={restaurentCardStyle}> 
      <center><img className="resImg" src={"https://media-assets.swiggy.com/swiggy/image/upload/fl_lossy,f_auto,q_auto,w_600,h_600/" +  cloudinaryImageId} /></center>
